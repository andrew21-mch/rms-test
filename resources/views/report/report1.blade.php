    ...
    <table class="table table-bordered" border="1px" style="width:900px;">
      <thead>
        <tr style="background-color:#DCDCDC">
          ...
          <th scope="col" class="col-md-1">Average</th>
    ...
    <tr>
      <td colspan="7">
        ...
        <tr>
          ...
          <td><input type="text" class="form-control" style="height:22px; width:80px; margin:1px 2px 1px 4px; font-size=10px" value="{{round($data->avg1, 2)}}" readonly></td>
        </tr>
        <tr>
          <td colspan="2"> Subjects Passed </td>
          <td><input type="text" class="form-control" style="height:22px; width:80px; margin:1px 2px 1px 4px; font-size=10px" value="{{$passed}}" readonly></td>
        </tr>
        <tr>
          <td colspan="2"> Subjects Failed </td>
          <td><input type="text" class="form-control" style="height:22px; width:80px; margin:1px 2px 1px 4px; font-size=10px" value="{{$countp}}" readonly></td>
        </tr>
