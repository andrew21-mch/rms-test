      ...
      <table class="table table-bordered" border="1px" style="width:900px;">
        ...
        <?php $avg = $data->avg2?>
          <tr style="height:30px; text-align:left">
            ...
            <td>{{$data->mark3}}</td>
            <td>{{$data->mark4}}</td>
            <?php if($data->mark3 == NULL){
              $data->mark3 = $data->mark4;
            }
            if($data->mark4 == NULL && $data->mark4 !== 0){
              $data->mark4 = $data->mark3;
            }
      ...
      <tr>
        <td colspan="7">
          ...
          <tr>
            ...
            <td><input type="text" class="form-control" style="height:22px; width:80px; margin:1px 2px 1px 4px;" value="{{$rank2}}"></td>
          </tr>
          <tr>
